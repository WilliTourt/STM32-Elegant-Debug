 ...
 *
 * This header provides a small C API that mirrors the C++
 * `ElegantDebug` class.
 ...
 *
 * Notes:
 *   - RA FSP / TI MSPM0: call `debug_tick()` from a 1 ms timer ISR for timestamps.
...
// RA FSP / TI MSPM0 tick provider (User must feed from timer ISR)
